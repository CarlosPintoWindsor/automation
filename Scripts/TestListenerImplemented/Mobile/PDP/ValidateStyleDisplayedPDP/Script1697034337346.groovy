...
WebUI.click(findTestObject('Regression/PDP/pdp_stylitics'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Regression/PDP/pdp_style_displayed'), 0)

...
WebUI.click(findTestObject('Mobile_Regression/mobile_pdp_store_inventory_message'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Mobile_Regression/mobile_pdp_search_zip'))

WebUI.sendKeys(findTestObject('Mobile_Regression/mobile_pdp_search_zip'), '99501')

WebUI.click(findTestObject('Regression/PDP/pdp_zip_go_btn'))

...
WebUI.verifyElementPresent(findTestObject('GlobalE/Desktop/lc_certona_trending_now_price'), 0)
...
localized_currency = WebUI.getText(findTestObject('GlobalE/Desktop/lc_certona_now_trending_price'))

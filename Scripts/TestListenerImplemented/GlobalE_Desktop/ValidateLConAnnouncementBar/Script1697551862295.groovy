...
WebUI.verifyElementPresent(findTestObject('GlobalE/Desktop/lc_desktop_announcement_bar'), 0)
...
WebUI.verifyElementText(findTestObject('GlobalE/Desktop/lc_desktop_announcement_bar'), 'CAD')

...
CustomKeywords.'com.Tools.testClick'(findTestObject('Regression/PLP/plp_view_24'))

CustomKeywords.'com.Tools.testClick'(findTestObject('Regression/PLP/plp_view_48'))

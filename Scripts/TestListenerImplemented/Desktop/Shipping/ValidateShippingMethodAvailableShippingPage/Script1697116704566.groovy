...
CustomKeywords.'com.Tools.testClick'(findTestObject('Regression/Information/info_state_select'))
...
CustomKeywords.'com.Tools.testClick'(findTestObject('Regression/Information/info_continue_shipping'))

WebUI.verifyElementPresent(findTestObject('Regression/Shipping/shipping_shipping_method'), 0)

WebUI.verifyElementPresent(findTestObject('Regression/Shipping/shipping_everyday_shipping'), 0)

WebUI.verifyElementPresent(findTestObject('Regression/Shipping/shipping_standard_shipping'), 0)

WebUI.verifyElementPresent(findTestObject('Regression/Shipping/shipping_expedited_shipping'), 0)

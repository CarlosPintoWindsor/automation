...
CustomKeywords.'com.Tools.testClick'(findTestObject('Regression/Shipping/shipping_everyday_shipping'))

WebUI.verifyElementPresent(findTestObject('Regression/Shipping/shipping_everyday_free'), 0)

CustomKeywords.'com.Tools.testClick'(findTestObject('Regression/Shipping/shipping_standard_shipping'))

WebUI.verifyElementPresent(findTestObject('Regression/Shipping/shipping_standard_995'), 0)

CustomKeywords.'com.Tools.testClick'(findTestObject('Regression/Shipping/shipping_expedited_shipping'))

...
CustomKeywords.'com.Tools.testClick'(findTestObject('Regression/Homepage/myaccount_menu_homepage'))

CustomKeywords.'com.Tools.testClick'(findTestObject('Regression/Homepage/myaccount_dropdown_submenu'))

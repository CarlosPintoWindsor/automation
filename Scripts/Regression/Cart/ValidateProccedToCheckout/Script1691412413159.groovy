...
WebUI.takeScreenshotAsCheckpoint('PROCEED TO CHECKOUT')

WebUI.verifyElementPresent(findTestObject('Regression/Cart/cart_checkout_shipping_address_validation'), 0)

...
WebUI.click(findTestObject('ABC_Prod_OR/Shoes and Accessories/submenu Rings'))

WebUI.click(findTestObject('Regression/Cart/cart_subtotal_less_75_item'))
...
WebUI.click(findTestObject('Regression/Cart/cart_certona_add_to_bag'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Regression/Cart/cart_bag_item_count_incr'), 0)

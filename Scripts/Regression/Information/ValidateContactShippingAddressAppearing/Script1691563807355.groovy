...
WebUI.verifyElementPresent(findTestObject('Regression/Information/info_contact'), 0)

WebUI.verifyElementPresent(findTestObject('Regression/Information/info_shipping_address'), 0)

WebUI.takeScreenshotAsCheckpoint('CONTACT ADDRESS SHIPPING')

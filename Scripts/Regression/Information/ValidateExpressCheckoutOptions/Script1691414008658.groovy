...
WebUI.verifyElementPresent(findTestObject('Regression/Information/Info_express_checkout'), 0)

WebUI.takeScreenshotAsCheckpoint('EXPRESS CHECKOUT')

WebUI.verifyElementPresent(findTestObject('Regression/Information/info_amazon_pay_btn'), 0)

WebUI.verifyElementPresent(findTestObject('Regression/Information/info_paypal_btn'), 0)

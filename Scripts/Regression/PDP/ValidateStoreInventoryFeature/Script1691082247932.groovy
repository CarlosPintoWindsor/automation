...
WebUI.click(findTestObject('Regression/PDP/pdp_store_inventory_message'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Regression/PDP/pdp_search_zip'))

...
WebUI.verifyElementPresent(findTestObject('Mobile_Regression/mobile_amazon_pay_btn'), 0)

WebUI.verifyElementPresent(findTestObject('Mobile_Regression/mobile_shoppay_btn'), 0)

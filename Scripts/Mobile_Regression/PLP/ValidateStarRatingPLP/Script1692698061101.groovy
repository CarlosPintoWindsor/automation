...
WebUI.mouseOver(findTestObject('Mobile_Regression/mobile_pdp_dress_selected'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Regression/PLP/plp_star_rating'), 0)

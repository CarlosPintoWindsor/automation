...
WebUI.click(findTestObject('Regression/Cart/cart_promo_message'), FailureHandling.STOP_ON_FAILURE)

WebUI.sendKeys(findTestObject('Regression/Cart/cart_promo_input'), 'SALE50')

WebUI.click(findTestObject('Regression/Cart/cart_promo_apply'), FailureHandling.STOP_ON_FAILURE)

...
WebUI.verifyElementText(findTestObject('Regression/Cart/cart_verify_correct_title'), 'Adalyn Brocade High Slit Dress')

WebUI.verifyElementText(findTestObject('Mobile_Regression/mobile_cart_verify_correct_price'), '$159.90', FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementText(findTestObject('Regression/Cart/cart_verify_correct_quantity'), '1')

WebUI.verifyElementText(findTestObject('Regression/Cart/cart_verify_correct_color'), 'Ivory')
